...
AGILE_TARIFF_BASE = (
  'https://api.octopus.energy/v1/products/AGILE-22-08-31/electricity-tariffs/E-1R-AGILE-22-08-31-')
...
try:
    ...
    conn = sqlite3.connect('/home/pi/octopus-agile-pi-prices/agileprices.sqlite')
    cursor = conn.cursor()
